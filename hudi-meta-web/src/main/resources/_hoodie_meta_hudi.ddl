...
-- 创建索引（可选，用于提高查询性能）
-- CREATE INDEX IF NOT EXISTS idx_meta_source ON _hoodie_meta_table(source_db, source_table);
-- CREATE INDEX IF NOT EXISTS idx_meta_status ON _hoodie_meta_table(status);
